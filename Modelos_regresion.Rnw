...
#resultados
stargazer(LinRegA,title = "Modelo de regresión propuesto para los datos de departamentos de cabecera", label = "stats")
#str(summary(colb))
@

<<summaryDatos, results=tex, echo=FALSE>>=
#resultados
stargazer(LinRegB,title = "Modelo de regresión propuesto para los datos de todos los departamentos", label = "stats")
#str(summary(colb))
@



Como se vio en la Tabla %\ref{regresiones}, cuando estÃ¡ presente el \emph{indice de libertad mundial}, el \emph{Ã?ndice de libertad de prensa} pierde significancia.
<<previousCode, results=hide, echo=FALSE >>=
